...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ReviewWithMoreThenFiveStart.class)
    public ResponseEntity<ErrorObject> handleReviewWithMoreThenFiveStart(ReviewWithMoreThenFiveStart ex, WebRequest request) {
        ErrorObject errorObject = new ErrorObject();
